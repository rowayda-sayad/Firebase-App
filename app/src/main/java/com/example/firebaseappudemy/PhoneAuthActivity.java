...
public class PhoneAuthActivity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                PhoneAuthOptions options =
                        PhoneAuthOptions.newBuilder(mAuth)
                                .setPhoneNumber(phoneEd.getText().toString())       // Phone number to verify
    ...
    PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationCompleted(PhoneAuthCredential credential) {
            ...
            Toast.makeText(PhoneAuthActivity.this, "Verified Auto", Toast.LENGTH_LONG).show();
            signInWithPhoneAuthCredential(credential);
        }
        ...
        public void onCodeSent(@NonNull String verificationId,
            ...
            Toast.makeText(PhoneAuthActivity.this, "Code been sent", Toast.LENGTH_LONG).show();
